...
print("Ends with e:")
b = [humans[i].name for i in range(len(humans)) if humans[i].name.endswith('e')]
print(b)
...
c = [humans[i].name for i in range(len(humans)) for l in abc[2:7] if humans[i].name.startswith(l)]
print(c)
...
e = [str(humans[i].name) + "-" + str(humans[i].age) for i in range(len(humans))]
print(e)
